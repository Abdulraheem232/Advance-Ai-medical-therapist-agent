...
from tools import query_medicalbot, call_emergency
...
def emergency_call_tool() -> None:
    ...
    """
    call_emergency(emergencynumber="+919")  # Replace with actual emergency number
...
llm = ChatGroq(model="openai/gpt-oss-120b", temperature=0.2, api_key="your_groq_api_key_here")
...
2. `find_near_by_therapists_by_location`: Use this tool if the user asks about nearby therapists or if recommending local professional help would be beneficial.
